<script lang="ts">
    ...
    const steps = [
        ...
        },
        {
            ...
            description:
                "Click the save button to store words and their meanings.",
        },
        {
            icon: Cloud,
...
<div class="flex flex-col h-full p-6">
    ...
    <div class="space-y-3">
        <button
            onclick={nextStep}
            class="w-full px-4 py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 font-medium flex items-center justify-center gap-2"
        >
